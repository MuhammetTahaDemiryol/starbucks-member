...
class EDUSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class EDUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EDUDateTimeConverter converter)
    {
        if(converter==null)
        {
    ...
    public static EDUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EDUDateTimeConverter dateTimeConverter = new EDUStandardDateTimeConverter();

    public EDUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EDUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EDUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EDUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EDUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EDUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
