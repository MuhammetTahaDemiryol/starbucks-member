...
public class EDUKPSPublicSoap
{
    ...
    public EDUKPSPublicSoap(){}

    public EDUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EDUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EDUExtendedSoapSerializationEnvelope envelope= new EDUExtendedSoapSerializationEnvelope(EDUExtendedSoapSerializationEnvelope.VER11);
